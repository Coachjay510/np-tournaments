    ...
    <div style={{ minHeight:"100vh", background:"#04060a", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <div style={{ width:380, padding:40, background:"#080c12", border:"1px solid #1a2030", borderRadius:16 }}>
        ...
        <button
          ...
          disabled={loading}
          style={{ width:"100%", display:"flex", alignItems:"center", justifyContent:"center", gap:10, background:"#fff", color:"#1a1a1a", border:"none", padding:"13px", borderRadius:8, fontWeight:600, fontSize:14, cursor:"pointer", opacity: loading ? 0.6 : 1 }}
        >
        ...
        {error && <div style={{ marginTop:16, fontSize:12, color:"#e05555", background:"#1f0707", border:"1px solid #3a0a0a", padding:"8px 12px", borderRadius:6 }}>{error}</div>}

        <div style={{ marginTop:20, fontSize:11, color:"#4a5568", textAlign:"center", lineHeight:1.6 }}>
          New here? Signing in will create your free account automatically.
        </div>
      </div>
    </div>
  )
