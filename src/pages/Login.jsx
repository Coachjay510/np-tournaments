  ...
  return (
    <div style={{ minHeight:"100vh", background:"#04060a", display:"flex", alignItems:"center", justifyContent:"center" }}>
      <div style={{ width:380, padding:40, background:"#080c12", border:"1px solid #1a2030", borderRadius:16 }}>
        ...
        <button onClick={handleGoogleLogin} disabled={googleLoading} style={{ width:"100%", display:"flex", alignItems:"center", justifyContent:"center", gap:10, background:"#fff", color:"#1a1a1a", border:"none", padding:"11px", borderRadius:8, fontWeight:600, fontSize:14, cursor:"pointer", marginBottom:20, opacity: googleLoading ? 0.6 : 1 }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          <div>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="director@example.com" style={{ width:"100%", background:"#0e1320", border:"1px solid #1a2030", color:"#d8e0f0", borderRadius:8, padding:"10px 12px", fontSize:13, outline:"none", boxSizing:"border-box" }} />
          </div>
          <div>
            <label style={{ fontSize:11, color:"#4a5568", textTransform:"uppercase", letterSpacing:1, display:"block", marginBottom:6 }}>Password</label>
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" style={{ width:"100%", background:"#0e1320", border:"1px solid #1a2030", color:"#d8e0f0", borderRadius:8, padding:"10px 12px", fontSize:13, outline:"none", boxSizing:"border-box" }} />
          </div>
