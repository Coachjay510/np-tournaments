        ...
        {error ? (
          ...
          <>
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: 'Anton, sans-serif', fontSize: 34, color: '#f0f4ff', letterSpacing: '0.5px', lineHeight: 1 }}>
                {team.display_name}
              </div>
            ...
            <div style={{ ...panelStyle, marginBottom: 20, border: '2px solid #5cb800' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                ...
                <label style={labelStyle}>
                  Division Key
                  <input
                    value={form.ranking_division_key}
                    onChange={(e) => setForm((prev) => ({ ...prev, ranking_division_key: e.target.value }))}
                    style={inputStyle}
                  />
                </label>
                ...
                <label style={labelStyle}>
                  ...
                  <input
                    ...
                    onChange={(e) => setForm((prev) => ({ ...prev, graduating_year: e.target.value }))}
                    style={inputStyle}
                  />
                </label>
                  ...
                  {linkedSources.map((source) => (
                    ...
                    >
                      <div style={{ color: '#f0f4ff', fontWeight: 700 }}>
                        {source.source_team_name}
                      </div>
                      <div style={{ color: '#6b7a99', fontSize: 12, marginTop: 4 }}>
                        {source.ranking_source} • {source.ranking_division_key} • Source Team ID {source.source_team_id}
                      </div>
                    </div>
                  ))}

                  {!linkedSources.length && (
                    <div style={{ color: '#6b7a99', fontSize: 12 }}>No linked sources found.</div>
                  )}
                </div>
              </div>
                ...
                <div style={{ overflowX: 'auto' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                      ...
                      {!recentGames.length && (
                        <tr>
                          <td colSpan={4} style={{ padding: 24, textAlign: 'center', color: '#4a5568' }}>
