  ...
  return (
    <div style={s.sidebar}>
      ...
      <div style={s.footer}>
        ...
        <button onClick={handleSignOut} style={{ marginTop:10, width:'100%', padding:'7px', background:'transparent', border:'1px solid #1a2030', borderRadius:6, color:'#4a5568', fontSize:12 }}>
          Sign out
        </button>
      </div>
    </div>
